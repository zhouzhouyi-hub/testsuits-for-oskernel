...
build-rv:
	...
	cp scripts/*.sh /code/sdcard/riscv/glibc
	cp scripts/*.sh /code/sdcard/riscv/musl
...
build-la:
	...
	cp scripts/*.sh /code/sdcard/loongarch/glibc
	cp scripts/*.sh /code/sdcard/loongarch/musl
